...
exports.verifyWhetherSelectedSlideIsDisplayed = exports.verifyWhetherBannerDisplayedForSelectedSlide = exports.verifyPlayStationPageTitle = exports.verifyNonSelectedSlides = exports.verifyMovingSlidesAutomatically = exports.verifyDisplayedCarouselSlides = exports.selectSubMenu = exports.clickSpecificSlide = exports.clickOnSpecificSlideToViewTheBanner = exports.clickAcceptCookiesBtn = void 0;
...
var verifyPlayStationPageTitle = exports.verifyPlayStationPageTitle = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(expectedValue) {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.t0 = _test.expect;
          _context.next = 3;
          return global.playStation.title();
        case 3:
          _context.t1 = _context.sent;
          (0, _context.t0)(_context.t1).toBe(expectedValue);
        case 5:
        case "end":
  ...
  return function verifyPlayStationPageTitle(_x) {
    return _ref.apply(this, arguments);
  };
}();
var clickAcceptCookiesBtn = exports.clickAcceptCookiesBtn = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return global.playStation.locator(locator.playStationpage_AcceptCookiesBtn);
        case 2:
  ...
  return function clickAcceptCookiesBtn() {
    return _ref2.apply(this, arguments);
  };
}();
function acceptCookies(_x2) {
  return _acceptCookies.apply(this, arguments);
}
function _acceptCookies() {
  _acceptCookies = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee11(locator) {
    var acceptButton_PlayStationPage;
    return _regeneratorRuntime().wrap(function _callee11$(_context11) {
      while (1) switch (_context11.prev = _context11.next) {
        ...
        case 2:
          acceptButton_PlayStationPage = _context11.sent;
          _context11.next = 5;
          return acceptButton_PlayStationPage.waitFor({
            state: "visible"
          });
...
function selectAnItemFromList(_x3, _x4) {
  return _selectAnItemFromList.apply(this, arguments);
}
function _selectAnItemFromList() {
  _selectAnItemFromList = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee12(listOfMenu, menuToSelect) {
...
var selectSubMenu = exports.selectSubMenu = /*#__PURE__*/function () {
  ...
  return function selectSubMenu(_x5, _x6) {
...
var clickSpecificSlide = exports.clickSpecificSlide = /*#__PURE__*/function () {
  ...
  return function clickSpecificSlide(_x7) {
    return _ref4.apply(this, arguments);
  };
}();
var verifyDisplayedCarouselSlides = exports.verifyDisplayedCarouselSlides = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 2:
          ...
          _context5.next = 5;
          return verifyCarouselSlides(listOfSlideItems);
        case 5:
        case "end":
  ...
  return function verifyDisplayedCarouselSlides() {
    return _ref5.apply(this, arguments);
  };
}();
function verifyCarouselSlides(_x8) {
  return _verifyCarouselSlides.apply(this, arguments);
}
function _verifyCarouselSlides() {
  _verifyCarouselSlides = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee13(listOfSlideItems) {
    var arr, count, _iterator2, _step2, menu;
...
var verifyWhetherSelectedSlideIsDisplayed = exports.verifyWhetherSelectedSlideIsDisplayed = /*#__PURE__*/function () {
  ...
  return function verifyWhetherSelectedSlideIsDisplayed(_x9) {
    return _ref6.apply(this, arguments);
  };
}();
var verifyWhetherBannerDisplayedForSelectedSlide = exports.verifyWhetherBannerDisplayedForSelectedSlide = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(selectedSlide) {
    ...
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        ...
        case 3:
          bigBanner = _context7.sent;
          _context7.t0 = _test.expect;
          _context7.next = 7;
          return bigBanner;
        case 7:
          _context7.t1 = _context7.sent;
          (0, _context7.t0)(_context7.t1).toBeVisible();
        case 9:
        case "end":
  ...
  return function verifyWhetherBannerDisplayedForSelectedSlide(_x10) {
    return _ref7.apply(this, arguments);
  };
}();
var verifyNonSelectedSlides = exports.verifyNonSelectedSlides = /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(slides) {
    var listOfSlides;
  ...
  return function verifyNonSelectedSlides(_x11) {
    return _ref8.apply(this, arguments);
  };
}();
function verifySelectedAndNonSelectedSlides(_x12, _x13) {
...
function _verifySelectedAndNonSelectedSlides() {
  _verifySelectedAndNonSelectedSlides = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee14(listOfSlide, selectedSlide) {
    ...
    }, _callee14, null, [[1, 18, 21, 24]]);
  }));
  return _verifySelectedAndNonSelectedSlides.apply(this, arguments);
}
var clickOnSpecificSlideToViewTheBanner = exports.clickOnSpecificSlideToViewTheBanner = /*#__PURE__*/function () {
  var _ref9 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9(slideToSelect) {
    var listOfSlides;
  ...
  return function clickOnSpecificSlideToViewTheBanner(_x14) {
    return _ref9.apply(this, arguments);
  };
}();
function clickOnSpecificSlide(_x15, _x16) {
  return _clickOnSpecificSlide.apply(this, arguments);
}
function _clickOnSpecificSlide() {
  _clickOnSpecificSlide = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee15(listOfSlide, slideToSelect) {
    var _iterator4, _step4, slide, str;
    return _regeneratorRuntime().wrap(function _callee15$(_context15) {
      while (1) switch (_context15.prev = _context15.next) {
        case 0:
          _iterator4 = _createForOfIteratorHelper(listOfSlide);
          _context15.prev = 1;
          _iterator4.s();
        case 3:
...
var verifyMovingSlidesAutomatically = exports.verifyMovingSlidesAutomatically = /*#__PURE__*/function () {
  ...
  return function verifyMovingSlidesAutomatically() {
    return _ref10.apply(this, arguments);
  };
}();
function verifySlideMoveAutomatically(_x17) {
...
function _verifySlideMoveAutomatically() {
  _verifySlideMoveAutomatically = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee16(locator) {
    var listOfSlides, count, _iterator5, _step5, menu;
    return _regeneratorRuntime().wrap(function _callee16$(_context16) {
      while (1) switch (_context16.prev = _context16.next) {
        ...
        case 2:
          ...
          count = 1;
          _iterator5 = _createForOfIteratorHelper(listOfSlides);
          _context16.prev = 5;
          _iterator5.s();
        case 7:
